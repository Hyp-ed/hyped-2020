...
#ifndef MOTOR_CONTROL_STATE_PROCESSOR_INTERFACE_HPP_
#define MOTOR_CONTROL_STATE_PROCESSOR_INTERFACE_HPP_
...
#endif  // MOTOR_CONTROL_STATE_PROCESSOR_INTERFACE_HPP_
